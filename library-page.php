                                    ...
                                    <div class="entry-content">
                                        <div class="sixteen columns alpha omega athletics">
                                            <div class="prairie-cat-holder">
                                                <div class="simpleTabs" id="tabber27">
                                                    <ul class="simpleTabsNavigation" role="tablist">
                                                        <li class="library-search-tab" role="tab" id="discovery-tab" aria-controls="tabber57_div_0" aria-selected="true"><a class="nav current" href="#" id="tabber27_a_0">Discovery</a></li>
                                                        <li class="library-search-tab" role="tab" id="prairie-cat-tab" aria-controls="tabber57_div_1"><a class="nav " href="#" id="tabber27_a_1">PrairieCat</a></li>
                                                        <li class="library-search-tab" role="tab" id="ebooks-tab" aria-controls="tabber57_div_2"><a class="nav " href="#" id="tabber27_a_2">eBooks</a></li>
                                                        <li class="library-search-tab" role="tab" id="articles-tab" aria-controls="tabber57_div_3"><a class="nav " href="#" id="tabber27_a_3">Articles</a></li>
                                                        <li class="library-search-tab" role="tab" id="videos-tab" aria-controls="tabber57_div_4"><a class="nav " href="#" id="tabber27_a_4">Videos</a></li>
                                                    </ul>
                                                    <div class="simpleTabsContent" role="tabpanel" aria-labelledby="discovery-tab">
                                                        <!-- BEGIN: General Custom Search Box-->
                                                        <form action="https://search.ebscohost.com/login.aspx" method="get" target="_blank" style="margin-bottom: 0" onsubmit="ebscoPreProcess(this)"><p />
                                                            ...
                                                            <input name="bquery" value="" type="hidden"><input name="uquery" size="65" type="text"><input value="Search" type="submit"><br>
                                                    ...
                                                    <div   class="simpleTabsContent" role="tabpanel" aria-labelledby="prairie-cat-tab"><p />
                                                    ...
                                                    <div  class="simpleTabsContent" role="tabpanel" aria-labelledby="ebooks-tab">
                                                        ...
                                                        <form action="https://search.ebscohost.com/login.aspx" method="get" target="_blank" style="margin-bottom: 0" onsubmit="ebscoPreProcess(this); limittoeBooks(this)"><p />
                                                            ...
                                                            <input name="clv0" value="Y" type="hidden">
                                                            <!-- search box and submit button -->
                                                            <input name="bquery" value="" type="hidden"><input name="uquery" size="65" type="text"><input value=" Search " type="submit"><br><br>

                                                        </form>
                                                    </div>


                                                    <div  class="simpleTabsContent" role="tabpanel" aria-labelledby="articles-tab">
                                                        <!-- Begin form which will construct a link into EDS https://support.epnet.com/knowledge_base/detail.php?id=2747#linksearch -->
                                                    ...
                                                    <div  class="simpleTabsContent" role="tabpanel" aria-labelledby="videos-tab">
                                                        <!-- Begin form which will construct a link into EDS https://support.epnet.com/knowledge_base/detail.php?id=2747#linksearch -->
